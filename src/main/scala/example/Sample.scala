...
//object Hello {
//
//  private def arrowWriteExample(): Unit = {
//    val rowsInBatch = 20
//
//    val alloc = new RootAllocator(20 * 8 + 100)
//
//    val name1 = "variable1"
//    val field1 = new Field(name1, FieldType.nullable(new ArrowType.FloatingPoint(FloatingPointPrecision.DOUBLE)), null)
//    val fields = List(field1)
//
//    val arrowSchema = new Schema(fields.asJava, null)
//    val vectorSchema: VectorSchemaRoot = VectorSchemaRoot.create(arrowSchema, alloc)
//    val dictionaryProvider = new DictionaryProvider.MapDictionaryProvider
//
//    val arrowFile = new File("./sample.arrow")
//    val fileOutputStream = new FileOutputStream(arrowFile)
//
//    val writer = new ArrowFileWriter(vectorSchema, dictionaryProvider, fileOutputStream.getChannel)
//    writer.start()
//
//    for (batch <- 0 until 100) {
//      println(s"writing batch number $batch")
//
//      val offset = batch * rowsInBatch
//
//      val fieldVectors = vectorSchema.getFieldVectors.asScala
//      val fieldVector =  fieldVectors(0).asInstanceOf[Float8Vector]
//      fieldVector.setInitialCapacity(rowsInBatch)
//      fieldVector.allocateNew()
//
//      for (i <- 0 until rowsInBatch) {
//        fieldVector.set(i, (i + offset).toDouble)
////        if (i % 2 != 0) {
...
//      fieldVector.close()
//
//      vectorSchema.setRowCount(rowsInBatch)
//      writer.writeBatch()
//    }
//
//    println(s"Bytes written: ${writer.bytesWritten()}")
//
//    writer.close()
//  }
//
//  private def arrowReaderExample(): Unit = {
//    println("Reading written file...")
//
//    val alloc = new RootAllocator(Integer.MAX_VALUE)
//    val arrowFile = new File("./sample.arrow")
//    val fileInputStream = new FileInputStream(arrowFile)
//
//    val reader = new ArrowFileReader(fileInputStream.getChannel, alloc)
//
//    val root = reader.getVectorSchemaRoot
//    val arrowBlocks = reader.getRecordBlocks
//
...
//    while (i < size) {
//
//      val rbBlock: ArrowBlock = arrowBlocks.get(i)
//      if (!reader.loadRecordBatch(rbBlock)) {
//        throw new IOException("Expected to read record batch")
//      }
//
//      totalRows += root.getRowCount
//
//      println("\t["+i+"] ArrowBlock, offset: " + rbBlock.getOffset +
//        ", metadataLength: " + rbBlock.getMetadataLength +
//        ", bodyLength " + rbBlock.getBodyLength)
//
//      var j = 0
//      val fieldVector = root.getFieldVectors
//      val numCols = fieldVector.size()
//
//      while (j < numCols) {
//        val fx = fieldVector.get(j)
//        fx.setValueCount(root.getRowCount)
//
//        fx.getMinorType match {
//          case MinorType.FLOAT8 =>
//            readFloat8(fx)
//
//          case _ =>
//            throw new Exception(fx.getMinorType + " is not implemented yet")
//        }
//
//        j += 1
//      }
...
//  }
//
//  private def readFloat8(fx: FieldVector): Unit = {
...
//
//    val alloc = new RootAllocator(Integer.MAX_VALUE)
//    println(alloc.getAllocatedMemory)
//
//    try {
//      val arrowFile = new File("./sample.arrow")
//      val fileInputStream = new FileInputStream(arrowFile)
//      val reader = new org.apache.arrow.vector.ipc.ArrowFileReader(fileInputStream.getChannel, alloc)
//
//      println(alloc.getAllocatedMemory)
//
//      // RecordBatchFileReader
//      val block = new ArrowBlock(0, 0, 0)
//
//      try {
//        val root = reader.getVectorSchemaRoot
//        reader.getRecordBlocks.asScala.foreach { block =>
//          if (!reader.loadRecordBatch(block)) {
//            throw new IOException("Expected to read record batch");
//          }
//
//          val fieldVector = root.getFieldVectors.asScala.toVector
//          fieldVector(0).getField.getName
//          fieldVector(0).getValueCount
//          fieldVector(0).getNullCount
//        }
//
//      } finally {
//        reader.close()
